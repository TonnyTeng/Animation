...
#define FOREGROUND_STAR_IMAGE_NAME @"gc_star_yellow"
#define BACKGROUND_STAR_IMAGE_NAME @"gc_star"
...
- (void)userTapRateView:(UITapGestureRecognizer *)gesture {
    ...
    self.scorePercent = [[NSString stringWithFormat:@"%.1f",starScore / self.numberOfStars] floatValue];
}
...
- (void)layoutSubviews {
    ...
    __weak ScoreView *weakSelf = self;
