...
//使用iOS中的CoreMotion框架。其中包括加速计、陀螺仪、磁力计等。代码中我们需要使用CMMotionManager对象进行响应功能的实现
...
//        _eyesImageView = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width / 2 - 380 / 4, 20, 37 / 2, 39 / 2)];
